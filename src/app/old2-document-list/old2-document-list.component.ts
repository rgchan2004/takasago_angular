...
@Component({
  selector: 'app-old2-document-list',
  templateUrl: './old2-document-list.component.html',
  styleUrls: ['./old2-document-list.component.css']
})
export class Old2DocumentListComponent {
  ...
  GetCdRequestList() {
    ...
    this._addProdutService.GetOld2CdRequestList()
